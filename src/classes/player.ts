...
class Player {
    ...
    setVar(variable: number, value: any): void {
        mod.SetVariable(
            mod.ObjectVariable(this._player, variable),
            value
        );
    }
     ...
     */
    equip(item: mod.Weapons | mod.Gadgets, gadgetPosition: mod.InventorySlots = mod.InventorySlots.GadgetOne): void {
     ...
     */
    equipGadget(gadget: mod.Gadgets, gadgetPosition: mod.InventorySlots = mod.InventorySlots.GadgetOne) {
    ...
    forceSwitch(inventorySlot: mod.InventorySlots) {
        mod.ForceSwitchInventory(this._player, mod.InventorySlots.PrimaryWeapon);
    }
